...
<div class="container" id="content">
    <div class="row">
    <div class="col-lg">
    <img src="img/2.jpg" style="float: right; width: 200px;">
        <h1>Get in Touch</h1>
    ...
    <div class="col-lg">
        <div style="float: right;">
            ...
            <p id="p1">România, Brașov - 500000</p><br>
            <p id="p1">Phone : +40 734569999</p><br>
            <p id="p1">Email : support@macmade.com</p>
        </div>
        <h1>CONTACT US</h1>
